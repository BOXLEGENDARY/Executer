...
class b {
    ...
    private static List<InterfaceC0336k0.c> c(List<EncoderProfiles.VideoProfile> list) {
        ...
        for (EncoderProfiles.VideoProfile videoProfile : list) {
            arrayList.add(InterfaceC0336k0.c.a(videoProfile.getCodec(), videoProfile.getMediaType(), videoProfile.getBitrate(), videoProfile.getFrameRate(), videoProfile.getWidth(), videoProfile.getHeight(), videoProfile.getProfile(), 8, 0, 0));
        }
        return arrayList;
    }
}
