...
public class BacktraceHandlerInputReport extends BacktraceHandlerInput {
    ...
    BacktraceHandlerInputReport(BacktraceData backtraceData, OnServerResponseEventListener onServerResponseEventListener, OnServerErrorEventListener onServerErrorEventListener, RequestHandler requestHandler) {
