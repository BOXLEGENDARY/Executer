...
public final class AFAdRevenueData {
    public final String currencyIso4217Code;
    public final MediationNetwork mediationNetwork;
    public final String monetizationNetwork;
    ...
    private final boolean AFAdRevenueData() {
        try {
            ...
            AFg1gSDK.w$default(AFLogger.INSTANCE, AFh1zSDK.AD_REVENUE, oyfFwvPUKctyaG.xhTomz, false, 4, null);
            return false;
        }
    }

    public static AFAdRevenueData copy$default(AFAdRevenueData aFAdRevenueData, String str, MediationNetwork mediationNetwork, String str2, double d7, int i7, Object obj) {
        if ((i7 & 1) != 0) {
        ...
        return aFAdRevenueData.copy(str, mediationNetwork2, str3, d7);
    }

    public final boolean areAllFieldsValid() {
        return !StringsKt.Y(this.monetizationNetwork) && AFAdRevenueData();
    }
    ...
    public final AFAdRevenueData copy(String monetizationNetwork, MediationNetwork mediationNetwork, String currencyIso4217Code, double revenue) {
        Intrinsics.checkNotNullParameter(monetizationNetwork, BuildConfig.FLAVOR);
        Intrinsics.checkNotNullParameter(mediationNetwork, BuildConfig.FLAVOR);
        Intrinsics.checkNotNullParameter(currencyIso4217Code, BuildConfig.FLAVOR);
