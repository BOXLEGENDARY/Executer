...
public class c {
    ...
    private static final ThreadLocal<Matrix> f18127a = new ThreadLocal<>();

    private static final ThreadLocal<RectF> f18128b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f18127a;
        ...
        ThreadLocal<RectF> threadLocal2 = f18128b;
