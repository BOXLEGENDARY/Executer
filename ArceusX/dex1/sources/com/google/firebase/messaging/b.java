...
public class b {
    ...
    public static void c(Intent intent) {
        if (intent != null) {
            if ("1".equals(intent.getStringExtra("google.c.a.tc"))) {
                R4.a aVar = (R4.a) Q4.c.i().g(R4.a.class);
    ...
    private static void f(String str, Intent intent) {
        ...
        String stringExtra2 = intent.getStringExtra(QXojhh.Akrb);
        if (stringExtra2 != null) {
            bundle.putString("_nmn", stringExtra2);
        }
        String stringExtra3 = intent.getStringExtra("google.c.a.m_l");
        if (!TextUtils.isEmpty(stringExtra3)) {
            bundle.putString(UJEa.ZXZmNaXn, stringExtra3);
        }
        ...
        if ("_nr".equals(str) || "_nf".equals(str)) {
            bundle.putString("_nmc", (intent.getExtras() == null || !n.d(intent.getExtras())) ? "data" : "display");
        }
        if (Log.isLoggable("FirebaseMessaging", 3)) {
            String strValueOf = String.valueOf(bundle);
            StringBuilder sb = new StringBuilder(String.valueOf(str).length() + 22 + strValueOf.length());
