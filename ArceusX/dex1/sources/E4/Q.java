...
public final class Q {
    ...
    private static final r0 f1101a = new r0("PhoneskyVerificationUtils");
        ...
        try {
            if (context.getPackageManager().getApplicationInfo("com.android.vending", 0).enabled) {
                ...
                if (signatureArr == null || (signatureArr.length) == 0) {
                    f1101a.e("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
                } else {
