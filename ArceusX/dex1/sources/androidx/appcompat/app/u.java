...
class u {
    ...
    private final Deque<WeakReference<XmlPullParser>> f8731a = new ArrayDeque();
    ...
    boolean a(AttributeSet attributeSet) {
        ...
        XmlPullParser xmlPullParserC = c(this.f8731a);
        this.f8731a.push(new WeakReference<>(xmlPullParser));
