...
public class AudioTimestampFramePositionIncorrectQuirk implements N0 {
    ...
    private static final List<String> f9555a = Arrays.asList("cph1920", "cph1923", "cph2015", "cph2083");

    private static boolean f() {
        return "oppo".equalsIgnoreCase(Build.BRAND) && f9555a.contains(Build.MODEL.toLowerCase(Locale.ROOT));
    }
