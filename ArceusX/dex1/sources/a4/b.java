...
public final class b {
    ...
    private static final Map f116a;

    private static final Map f117b;
    ...
    static {
        ...
        map.put(-12, wtzgsqRsIZB.FeaqHmECN);
        map.put(-14, "The Play Store needs to be updated.\nAsk the user to update the Google Play Store.\n");
        map.put(-15, hgESaf.KkFFMXCuvNXVsH);
        ...
        map2.put(-12, EZYiRMRTxKdo.CypXsFYZwvOiYj);
    ...
    public static String a(int i7) {
        ...
        return ((String) map.get(numValueOf)) + " (https://developer.android.com/google/play/integrity/reference/com/google/android/play/core/integrity/model/StandardIntegrityErrorCode.html#" + ((String) map2.get(numValueOf)) + GObvYfBKohxpYX.KVGUdNWVEN;
    }
}
