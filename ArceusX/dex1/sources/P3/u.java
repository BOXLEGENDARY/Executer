...
public final class u implements Parcelable.Creator<zzi> {
    @Override
    public final zzi createFromParcel(Parcel parcel) {
        ...
        C2678a.l(parcel, iC);
        return new zzi(strG, strG2, strG3, strG4, strG5, strG6, strG7, strG8, strG9, strG10, strG11, strG12, strG13, strG14);
    }

    @Override
    public final zzi[] newArray(int i7) {
        return new zzi[i7];
    }
}
