...
public final class T {
    ...
    static final class a extends kotlin.jvm.internal.l implements Function0<Unit> {
        final InputSelectComponent d;
        final q9.r e;

        a(InputSelectComponent inputSelectComponent, q9.r rVar) {
            super(0);
            this.d = inputSelectComponent;
            this.e = rVar;
        }
    ...
    @NotNull
    public static final TextInputLayout a(@NotNull InputSelectComponent inputSelectComponent, @NotNull s0 s0Var) {
        EditText editText;
        ...
        InputSelect.Attributes attributes = inputSelectComponent.e().getAttributes();
        if (attributes != null) {
            ...
            if (prefill != null && (editText = rVarD.a().getEditText()) != null) {
        ...
        s0Var.d(new a(inputSelectComponent, rVarD));
