...
public final class LowLightHint implements Hint {
    ...
    @NotNull
    public static final LowLightHint d = new LowLightHint();
    ...
    public static final class a implements Parcelable.Creator<LowLightHint> {
        @Override
        @NotNull
        public final LowLightHint createFromParcel(@NotNull Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            parcel.readInt();
            return LowLightHint.d;
        }
    ...
    public boolean equals(Object other) {
        return this == other || (other instanceof LowLightHint);
    }
