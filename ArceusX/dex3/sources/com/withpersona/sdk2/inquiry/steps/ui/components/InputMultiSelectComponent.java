...
public final class InputMultiSelectComponent implements UiComponent, c0<InputMultiSelectComponent>, S, InterfaceC0684l, InterfaceC0689q {
    ...
    @NotNull
    private final InputMultiSelect config;
    ...
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0015\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"Lcom/withpersona/sdk2/inquiry/steps/ui/components/InputMultiSelectComponent$a;", "", "<init>", "()V", "Lcom/withpersona/sdk2/inquiry/network/dto/ui/components/InputMultiSelect;", "config", "Lcom/withpersona/sdk2/inquiry/steps/ui/components/InputMultiSelectComponent;", "a", "(Lcom/withpersona/sdk2/inquiry/network/dto/ui/components/InputMultiSelect;)Lcom/withpersona/sdk2/inquiry/steps/ui/components/InputMultiSelectComponent;", "ui-step-renderer_release"}, k = 1, mv = {1, R.styleable.LottieAnimationView_lottie_progress, 0}, xi = 48)
    public static final class Companion {
        ...
        @NotNull
        public final InputMultiSelectComponent a(@NotNull InputMultiSelect config) {
            Set setD;
            List listJ;
            List<String> prefill;
            ...
            if (attributes2 == null || (prefill = attributes2.getPrefill()) == null || (setD = CollectionsKt.v0(prefill)) == null) {
                setD = L.d();
            }
            if (options != null) {
            ...
            return new InputMultiSelectComponent(config, config.getStyles(), listJ);
        }
    ...
    public static final class b implements Parcelable.Creator<InputMultiSelectComponent> {
        @Override
        @NotNull
        public final InputMultiSelectComponent createFromParcel(@NotNull Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            InputMultiSelect inputMultiSelect = (InputMultiSelect) parcel.readParcelable(InputMultiSelectComponent.class.getClassLoader());
    ...
    public InputMultiSelectComponent(@NotNull InputMultiSelect inputMultiSelect, InputSelectComponentStyle inputSelectComponentStyle, @NotNull List<Option> list) {
        List<Option> listJ;
        List<com.withpersona.sdk2.inquiry.network.dto.ui.components.Option> options;
        Intrinsics.checkNotNullParameter(inputMultiSelect, "config");
        Intrinsics.checkNotNullParameter(list, "selectedOptions");
        this.config = inputMultiSelect;
        this.styles = inputSelectComponentStyle;
        this.selectedOptions = list;
        this.associatedViews = new ArrayList();
        this.canSelectMultipleValues = true;
        InputMultiSelect.Attributes attributes = e().getAttributes();
        this.label = attributes != null ? attributes.getLabel() : null;
        this.name = e().getName();
        InputMultiSelect.Attributes attributes2 = e().getAttributes();
        this.placeholder = attributes2 != null ? attributes2.getPlaceholder() : null;
        InputMultiSelect.Attributes attributes3 = e().getAttributes();
    ...
    public static InputMultiSelectComponent k(InputMultiSelectComponent inputMultiSelectComponent, InputMultiSelect inputMultiSelect, InputSelectComponentStyle inputSelectComponentStyle, List list, int i, Object obj) {
        if ((i & 1) != 0) {
            inputMultiSelect = inputMultiSelectComponent.config;
        }
        if ((i & 2) != 0) {
        ...
        return inputMultiSelectComponent.h(inputMultiSelect, inputSelectComponentStyle, list);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.b(this.config, inputMultiSelectComponent.config) && Intrinsics.b(this.styles, inputMultiSelectComponent.styles) && Intrinsics.b(this.selectedOptions, inputMultiSelectComponent.selectedOptions);
    }
    ...
    @NotNull
    public final InputMultiSelectComponent h(@NotNull InputMultiSelect config, InputSelectComponentStyle styles, @NotNull List<Option> selectedOptions) {
        Intrinsics.checkNotNullParameter(config, "config");
        Intrinsics.checkNotNullParameter(selectedOptions, "selectedOptions");
        return new InputMultiSelectComponent(config, styles, selectedOptions);
    }
    ...
    @Override
    @NotNull
    public InputMultiSelectComponent g(@NotNull List<Option> selectedOptions) {
        Intrinsics.checkNotNullParameter(selectedOptions, "selectedOptions");
        InputMultiSelectComponent inputMultiSelectComponentK = k(this, null, null, selectedOptions, 3, null);
        inputMultiSelectComponentK.o(getSelectedOptionsController());
        return inputMultiSelectComponentK;
    }
