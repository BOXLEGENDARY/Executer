...
public final class Text implements UiComponentConfig {
    ...
    public Text(@NotNull String str, Attributes attributes, TextBasedComponentStyle textBasedComponentStyle) {
        this.name = str;
    ...
    public Text(String str, Attributes attributes, TextBasedComponentStyle textBasedComponentStyle, int i, DefaultConstructorMarker defaultConstructorMarker) {
