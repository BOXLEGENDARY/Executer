...
public final class AttributeStyles_FooterColorStyleJsonAdapter extends h<AttributeStyles.FooterColorStyle> {
    ...
    public AttributeStyles_FooterColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.FooterColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.FooterColorStyle m363fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.FooterColorStyle footerColorStyle) {
        if (footerColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableSimpleElementColorAdapter.toJson(tVar, footerColorStyle.getBase());
        tVar.y();
    }
}
