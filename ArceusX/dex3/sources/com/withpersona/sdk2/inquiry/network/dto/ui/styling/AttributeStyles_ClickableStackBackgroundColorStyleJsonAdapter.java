...
public final class AttributeStyles_ClickableStackBackgroundColorStyleJsonAdapter extends h<AttributeStyles.ClickableStackBackgroundColorStyle> {
    ...
    public AttributeStyles_ClickableStackBackgroundColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ClickableStackBackgroundColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ClickableStackBackgroundColorStyle m328fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ClickableStackBackgroundColorStyle clickableStackBackgroundColorStyle) {
        if (clickableStackBackgroundColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableComplexElementColorAdapter.toJson(tVar, clickableStackBackgroundColorStyle.getBase());
        tVar.y();
    }
}
