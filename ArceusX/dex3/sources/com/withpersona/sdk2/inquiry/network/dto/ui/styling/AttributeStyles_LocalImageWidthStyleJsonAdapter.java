...
public final class AttributeStyles_LocalImageWidthStyleJsonAdapter extends h<AttributeStyles.LocalImageWidthStyle> {
    ...
    public AttributeStyles_LocalImageWidthStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.LocalImageWidthStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.LocalImageWidthStyle m417fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.LocalImageWidthStyle localImageWidthStyle) {
        if (localImageWidthStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, localImageWidthStyle.getBase());
        tVar.y();
    }
}
