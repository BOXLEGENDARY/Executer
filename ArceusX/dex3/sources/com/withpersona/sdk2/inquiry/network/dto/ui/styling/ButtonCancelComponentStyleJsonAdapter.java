...
public final class ButtonCancelComponentStyleJsonAdapter extends h<ButtonCancelComponentStyle> {
    ...
    public ButtonCancelComponentStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("ButtonCancelComponentStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public ButtonCancelComponentStyle m440fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, ButtonCancelComponentStyle buttonCancelComponentStyle) {
        if (buttonCancelComponentStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("padding");
        this.nullableButtonBasedPaddingStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getPadding());
        tVar.Z("margin");
        this.nullableButtonBasedMarginStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getMargin());
        tVar.Z("justify");
        this.nullableButtonBasedJustifyStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getJustify());
        tVar.Z("fontFamily");
        this.nullableButtonBasedFontFamilyStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getFontFamily());
        tVar.Z("fontSize");
        this.nullableButtonBasedFontSizeStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getFontSize());
        tVar.Z("fontWeight");
        this.nullableButtonBasedFontWeightStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getFontWeight());
        tVar.Z("letterSpacing");
        this.nullableButtonBasedLetterSpacingStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getLetterSpacing());
        tVar.Z("lineHeight");
        this.nullableButtonBasedLineHeightStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getLineHeight());
        tVar.Z("textColor");
        this.nullableButtonBasedTextColorStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getTextColor());
        tVar.Z("height");
        this.nullableButtonBasedHeightStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getHeight());
        tVar.Z("width");
        this.nullableButtonBasedWidthStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getWidth());
        tVar.Z("backgroundColor");
        this.nullableButtonBasedBackgroundColorStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getBackgroundColor());
        tVar.Z("borderColor");
        this.nullableButtonBasedBorderColorStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getBorderColor());
        tVar.Z("borderRadius");
        this.nullableButtonBasedBorderRadiusStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getBorderRadius());
        tVar.Z("borderWidth");
        this.nullableButtonBasedBorderWidthStyleAdapter.toJson(tVar, buttonCancelComponentStyle.getBorderWidth());
        tVar.y();
    }
}
