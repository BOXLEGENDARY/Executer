...
public final class StepStyles_DocumentStepTitleComponentStyleJsonAdapter extends h<StepStyles.DocumentStepTitleComponentStyle> {
    ...
    @NotNull
    private final m.b options = m.b.a(new String[]{"base", "documentProcessingTitle"});

    public StepStyles_DocumentStepTitleComponentStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("StepStyles.DocumentStepTitleComponentStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public StepStyles.DocumentStepTitleComponentStyle m459fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, StepStyles.DocumentStepTitleComponentStyle documentStepTitleComponentStyle) {
        if (documentStepTitleComponentStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableStepTextBasedComponentStyleContainerAdapter.toJson(tVar, documentStepTitleComponentStyle.getBase());
        tVar.Z("documentProcessingTitle");
        this.nullableStepTextBasedComponentStyleContainerAdapter.toJson(tVar, documentStepTitleComponentStyle.getDocumentProcessingTitle());
        tVar.y();
    }
}
