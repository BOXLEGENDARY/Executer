...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_FileLimitExceededErrorJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError> {
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_FileLimitExceededErrorJsonAdapter(@NotNull w wVar) {
        ...
        this.detailsAdapter = wVar.f(GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError.Details.class, L.d(), "details");
    }
    ...
    @NotNull
    public GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError m105fromJson(@NotNull m mVar) throws j {
        mVar.e();
        String str = null;
        String str2 = null;
        ...
        while (mVar.u()) {
            ...
            } else if (iP0 == 2 && (details = (GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError.Details) this.detailsAdapter.fromJson(mVar)) == null) {
