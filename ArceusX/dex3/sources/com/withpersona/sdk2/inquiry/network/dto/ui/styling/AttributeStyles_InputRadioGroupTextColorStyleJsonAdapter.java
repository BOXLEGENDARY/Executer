...
public final class AttributeStyles_InputRadioGroupTextColorStyleJsonAdapter extends h<AttributeStyles.InputRadioGroupTextColorStyle> {
    ...
    public AttributeStyles_InputRadioGroupTextColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputRadioGroupTextColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputRadioGroupTextColorStyle m395fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputRadioGroupTextColorStyle inputRadioGroupTextColorStyle) {
        if (inputRadioGroupTextColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableSimpleElementColorAdapter.toJson(tVar, inputRadioGroupTextColorStyle.getBase());
        tVar.Z("description");
        this.nullableSimpleElementColorAdapter.toJson(tVar, inputRadioGroupTextColorStyle.getDescription());
        tVar.Z("error");
        this.nullableSimpleElementColorAdapter.toJson(tVar, inputRadioGroupTextColorStyle.getError());
        tVar.y();
    }
}
