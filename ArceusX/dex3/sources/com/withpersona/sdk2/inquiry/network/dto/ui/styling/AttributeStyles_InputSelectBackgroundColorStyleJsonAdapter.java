...
public final class AttributeStyles_InputSelectBackgroundColorStyleJsonAdapter extends h<AttributeStyles.InputSelectBackgroundColorStyle> {
    ...
    public AttributeStyles_InputSelectBackgroundColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputSelectBackgroundColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputSelectBackgroundColorStyle m396fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputSelectBackgroundColorStyle inputSelectBackgroundColorStyle) {
        if (inputSelectBackgroundColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableSimpleElementColorAdapter.toJson(tVar, inputSelectBackgroundColorStyle.getBase());
        tVar.y();
    }
}
