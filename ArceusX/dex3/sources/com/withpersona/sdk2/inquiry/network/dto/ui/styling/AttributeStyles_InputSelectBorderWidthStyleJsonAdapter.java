...
public final class AttributeStyles_InputSelectBorderWidthStyleJsonAdapter extends h<AttributeStyles.InputSelectBorderWidthStyle> {
    ...
    public AttributeStyles_InputSelectBorderWidthStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputSelectBorderWidthStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputSelectBorderWidthStyle m399fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputSelectBorderWidthStyle inputSelectBorderWidthStyle) {
        if (inputSelectBorderWidthStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementSetAdapter.toJson(tVar, inputSelectBorderWidthStyle.getBase());
        tVar.y();
    }
}
