...
public final class AttributeStyles_HorizontalStackBackgroundColorStyleJsonAdapter extends h<AttributeStyles.HorizontalStackBackgroundColorStyle> {
    ...
    public AttributeStyles_HorizontalStackBackgroundColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.HorizontalStackBackgroundColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.HorizontalStackBackgroundColorStyle m374fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.HorizontalStackBackgroundColorStyle horizontalStackBackgroundColorStyle) {
        if (horizontalStackBackgroundColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableSimpleElementColorAdapter.toJson(tVar, horizontalStackBackgroundColorStyle.getBase());
        tVar.y();
    }
}
