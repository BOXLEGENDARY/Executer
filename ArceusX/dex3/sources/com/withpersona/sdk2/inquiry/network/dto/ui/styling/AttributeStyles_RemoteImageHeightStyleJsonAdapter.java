...
public final class AttributeStyles_RemoteImageHeightStyleJsonAdapter extends h<AttributeStyles.RemoteImageHeightStyle> {
    ...
    public AttributeStyles_RemoteImageHeightStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.RemoteImageHeightStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.RemoteImageHeightStyle m424fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.RemoteImageHeightStyle remoteImageHeightStyle) {
        if (remoteImageHeightStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, remoteImageHeightStyle.getBase());
        tVar.y();
    }
}
