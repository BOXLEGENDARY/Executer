...
public final class AttributeStyles_ClickableStackChildSizesStyleJsonAdapter extends h<AttributeStyles.ClickableStackChildSizesStyle> {
    ...
    public AttributeStyles_ClickableStackChildSizesStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ClickableStackChildSizesStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ClickableStackChildSizesStyle m332fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ClickableStackChildSizesStyle clickableStackChildSizesStyle) {
        if (clickableStackChildSizesStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableChildSizesAdapter.toJson(tVar, clickableStackChildSizesStyle.getBase());
        tVar.y();
    }
}
