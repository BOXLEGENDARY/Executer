...
public final class AttributeStyles_LocalImageStrokeColorStyleJsonAdapter extends h<AttributeStyles.LocalImageStrokeColorStyle> {
    ...
    public AttributeStyles_LocalImageStrokeColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.LocalImageStrokeColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.LocalImageStrokeColorStyle m416fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.LocalImageStrokeColorStyle localImageStrokeColorStyle) {
        if (localImageStrokeColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableSimpleElementColorAdapter.toJson(tVar, localImageStrokeColorStyle.getBase());
        tVar.y();
    }
}
