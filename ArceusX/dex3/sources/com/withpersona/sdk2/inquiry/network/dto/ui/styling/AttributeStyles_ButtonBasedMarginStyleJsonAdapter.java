...
public final class AttributeStyles_ButtonBasedMarginStyleJsonAdapter extends h<AttributeStyles.ButtonBasedMarginStyle> {
    ...
    public AttributeStyles_ButtonBasedMarginStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ButtonBasedMarginStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ButtonBasedMarginStyle m322fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ButtonBasedMarginStyle buttonBasedMarginStyle) {
        if (buttonBasedMarginStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementSetAdapter.toJson(tVar, buttonBasedMarginStyle.getBase());
        tVar.y();
    }
}
