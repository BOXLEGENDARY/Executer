...
public final class ButtonSubmitComponentStyleJsonAdapter extends h<ButtonSubmitComponentStyle> {
    ...
    public ButtonSubmitComponentStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("ButtonSubmitComponentStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public ButtonSubmitComponentStyle m444fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, ButtonSubmitComponentStyle buttonSubmitComponentStyle) {
        if (buttonSubmitComponentStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("padding");
        this.nullableButtonBasedPaddingStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getPadding());
        tVar.Z("margin");
        this.nullableButtonBasedMarginStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getMargin());
        tVar.Z("justify");
        this.nullableButtonBasedJustifyStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getJustify());
        tVar.Z("fontFamily");
        this.nullableButtonBasedFontFamilyStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getFontFamily());
        tVar.Z("fontSize");
        this.nullableButtonBasedFontSizeStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getFontSize());
        tVar.Z("fontWeight");
        this.nullableButtonBasedFontWeightStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getFontWeight());
        tVar.Z("letterSpacing");
        this.nullableButtonBasedLetterSpacingStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getLetterSpacing());
        tVar.Z("lineHeight");
        this.nullableButtonBasedLineHeightStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getLineHeight());
        tVar.Z("textColor");
        this.nullableButtonBasedTextColorStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getTextColor());
        tVar.Z("height");
        this.nullableButtonBasedHeightStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getHeight());
        tVar.Z("width");
        this.nullableButtonBasedWidthStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getWidth());
        tVar.Z("backgroundColor");
        this.nullableButtonBasedBackgroundColorStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getBackgroundColor());
        tVar.Z("borderColor");
        this.nullableButtonBasedBorderColorStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getBorderColor());
        tVar.Z("borderRadius");
        this.nullableButtonBasedBorderRadiusStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getBorderRadius());
        tVar.Z("borderWidth");
        this.nullableButtonBasedBorderWidthStyleAdapter.toJson(tVar, buttonSubmitComponentStyle.getBorderWidth());
        tVar.y();
    }
}
