...
public final class InputCurrency_AttributesJsonAdapter extends h<InputCurrency.Attributes> {
    ...
    @NotNull
    private final m.b options = m.b.a(new String[]{"prefill", "label", "placeholder", "hidden", "disabled", "currencyCode"});

    public InputCurrency_AttributesJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("InputCurrency.Attributes");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public InputCurrency.Attributes m259fromJson(@NotNull m mVar) {
        mVar.e();
        Number number = null;
        String str = null;
        String str2 = null;
    ...
    public void toJson(@NotNull t tVar, InputCurrency.Attributes attributes) {
        if (attributes == null) {
        ...
        tVar.Z("currencyCode");
        this.nullableStringAdapter.toJson(tVar, attributes.getCurrencyCode());
        tVar.y();
    }
}
