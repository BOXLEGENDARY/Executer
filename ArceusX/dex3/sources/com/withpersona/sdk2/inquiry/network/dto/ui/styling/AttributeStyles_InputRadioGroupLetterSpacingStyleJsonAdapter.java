...
public final class AttributeStyles_InputRadioGroupLetterSpacingStyleJsonAdapter extends h<AttributeStyles.InputRadioGroupLetterSpacingStyle> {
    ...
    public AttributeStyles_InputRadioGroupLetterSpacingStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputRadioGroupLetterSpacingStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputRadioGroupLetterSpacingStyle m393fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputRadioGroupLetterSpacingStyle inputRadioGroupLetterSpacingStyle) {
        if (inputRadioGroupLetterSpacingStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, inputRadioGroupLetterSpacingStyle.getBase());
        tVar.Z("description");
        this.nullableMeasurementAdapter.toJson(tVar, inputRadioGroupLetterSpacingStyle.getDescription());
        tVar.Z("error");
        this.nullableMeasurementAdapter.toJson(tVar, inputRadioGroupLetterSpacingStyle.getError());
        tVar.y();
    }
}
