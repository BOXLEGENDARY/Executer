...
public final class AttributeStyles_InputSelectTextLetterSpacingStyleJsonAdapter extends h<AttributeStyles.InputSelectTextLetterSpacingStyle> {
    ...
    public AttributeStyles_InputSelectTextLetterSpacingStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputSelectTextLetterSpacingStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputSelectTextLetterSpacingStyle m405fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputSelectTextLetterSpacingStyle inputSelectTextLetterSpacingStyle) {
        if (inputSelectTextLetterSpacingStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, inputSelectTextLetterSpacingStyle.getBase());
        tVar.Z("label");
        this.nullableMeasurementAdapter.toJson(tVar, inputSelectTextLetterSpacingStyle.getLabel());
        tVar.Z("error");
        this.nullableMeasurementAdapter.toJson(tVar, inputSelectTextLetterSpacingStyle.getError());
        tVar.y();
    }
}
