...
public final class AttributeStyles_InputSelectBorderColorStyleJsonAdapter extends h<AttributeStyles.InputSelectBorderColorStyle> {
    ...
    public AttributeStyles_InputSelectBorderColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputSelectBorderColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputSelectBorderColorStyle m397fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputSelectBorderColorStyle inputSelectBorderColorStyle) {
        if (inputSelectBorderColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableComplexElementColorAdapter.toJson(tVar, inputSelectBorderColorStyle.getBase());
        tVar.y();
    }
}
