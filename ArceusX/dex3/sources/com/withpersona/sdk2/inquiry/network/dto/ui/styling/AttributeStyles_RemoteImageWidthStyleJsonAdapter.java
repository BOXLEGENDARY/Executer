...
public final class AttributeStyles_RemoteImageWidthStyleJsonAdapter extends h<AttributeStyles.RemoteImageWidthStyle> {
    ...
    public AttributeStyles_RemoteImageWidthStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.RemoteImageWidthStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.RemoteImageWidthStyle m428fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.RemoteImageWidthStyle remoteImageWidthStyle) {
        if (remoteImageWidthStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, remoteImageWidthStyle.getBase());
        tVar.y();
    }
}
