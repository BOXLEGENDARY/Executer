...
public final class AttributeStyles_HorizontalStackAxisStyleJsonAdapter extends h<AttributeStyles.HorizontalStackAxisStyle> {
    ...
    public AttributeStyles_HorizontalStackAxisStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.HorizontalStackAxisStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.HorizontalStackAxisStyle m373fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.HorizontalStackAxisStyle horizontalStackAxisStyle) {
        if (horizontalStackAxisStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableAxisContainerAdapter.toJson(tVar, horizontalStackAxisStyle.getBase());
        tVar.y();
    }
}
