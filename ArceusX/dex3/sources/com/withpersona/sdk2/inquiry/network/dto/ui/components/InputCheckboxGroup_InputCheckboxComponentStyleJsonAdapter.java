...
public final class InputCheckboxGroup_InputCheckboxComponentStyleJsonAdapter extends h<InputCheckboxGroup.InputCheckboxComponentStyle> {
    ...
    public InputCheckboxGroup_InputCheckboxComponentStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("InputCheckboxGroup.InputCheckboxComponentStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public InputCheckboxGroup.InputCheckboxComponentStyle m252fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, InputCheckboxGroup.InputCheckboxComponentStyle inputCheckboxComponentStyle) {
