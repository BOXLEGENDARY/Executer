...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_PageLimitExceededErrorJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.PageLimitExceededError> {
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_PageLimitExceededErrorJsonAdapter(@NotNull w wVar) {
        ...
        this.detailsAdapter = wVar.f(GenericFileUploadErrorResponse.DocumentErrorResponse.PageLimitExceededError.Details.class, L.d(), "details");
    }
    ...
    @NotNull
    public GenericFileUploadErrorResponse.DocumentErrorResponse.PageLimitExceededError m115fromJson(@NotNull m mVar) throws j {
        mVar.e();
        String str = null;
        String str2 = null;
        ...
        while (mVar.u()) {
            ...
            } else if (iP0 == 2 && (details = (GenericFileUploadErrorResponse.DocumentErrorResponse.PageLimitExceededError.Details) this.detailsAdapter.fromJson(mVar)) == null) {
