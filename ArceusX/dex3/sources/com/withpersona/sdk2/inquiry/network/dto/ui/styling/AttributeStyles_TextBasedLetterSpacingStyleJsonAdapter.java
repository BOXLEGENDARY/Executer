...
public final class AttributeStyles_TextBasedLetterSpacingStyleJsonAdapter extends h<AttributeStyles.TextBasedLetterSpacingStyle> {
    ...
    public AttributeStyles_TextBasedLetterSpacingStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.TextBasedLetterSpacingStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.TextBasedLetterSpacingStyle m435fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.TextBasedLetterSpacingStyle textBasedLetterSpacingStyle) {
        if (textBasedLetterSpacingStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, textBasedLetterSpacingStyle.getBase());
        tVar.y();
    }
}
