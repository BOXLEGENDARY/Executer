...
public final class AttributeStyles_InputSelectBorderRadiusStyleJsonAdapter extends h<AttributeStyles.InputSelectBorderRadiusStyle> {
    ...
    public AttributeStyles_InputSelectBorderRadiusStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputSelectBorderRadiusStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputSelectBorderRadiusStyle m398fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputSelectBorderRadiusStyle inputSelectBorderRadiusStyle) {
        if (inputSelectBorderRadiusStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, inputSelectBorderRadiusStyle.getBase());
        tVar.y();
    }
}
