...
public final class AttributeStyles_RemoteImageMarginStyleJsonAdapter extends h<AttributeStyles.RemoteImageMarginStyle> {
    ...
    public AttributeStyles_RemoteImageMarginStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.RemoteImageMarginStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.RemoteImageMarginStyle m426fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.RemoteImageMarginStyle remoteImageMarginStyle) {
        if (remoteImageMarginStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementSetAdapter.toJson(tVar, remoteImageMarginStyle.getBase());
        tVar.y();
    }
}
