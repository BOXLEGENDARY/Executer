...
public final class AttributeStyles_DateSelectBorderRadiusStyleJsonAdapter extends h<AttributeStyles.DateSelectBorderRadiusStyle> {
    ...
    public AttributeStyles_DateSelectBorderRadiusStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.DateSelectBorderRadiusStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.DateSelectBorderRadiusStyle m345fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.DateSelectBorderRadiusStyle dateSelectBorderRadiusStyle) {
        if (dateSelectBorderRadiusStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, dateSelectBorderRadiusStyle.getBase());
        tVar.y();
    }
}
