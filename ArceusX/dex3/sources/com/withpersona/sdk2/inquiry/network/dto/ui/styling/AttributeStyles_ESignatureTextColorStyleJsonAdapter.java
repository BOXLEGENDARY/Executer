...
public final class AttributeStyles_ESignatureTextColorStyleJsonAdapter extends h<AttributeStyles.ESignatureTextColorStyle> {
    ...
    public AttributeStyles_ESignatureTextColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ESignatureTextColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ESignatureTextColorStyle m359fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ESignatureTextColorStyle eSignatureTextColorStyle) {
        if (eSignatureTextColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("value");
        this.nullableComplexElementColorAdapter.toJson(tVar, eSignatureTextColorStyle.getValue());
        tVar.Z("placeholder");
        this.nullableComplexElementColorAdapter.toJson(tVar, eSignatureTextColorStyle.getPlaceholder());
        tVar.Z("label");
        this.nullableComplexElementColorAdapter.toJson(tVar, eSignatureTextColorStyle.getLabel());
        tVar.Z("error");
        this.nullableComplexElementColorAdapter.toJson(tVar, eSignatureTextColorStyle.getError());
        tVar.y();
    }
}
