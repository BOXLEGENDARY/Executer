...
public final class AttributeStyles_SpacerWidthStyleJsonAdapter extends h<AttributeStyles.SpacerWidthStyle> {
    ...
    public AttributeStyles_SpacerWidthStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.SpacerWidthStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.SpacerWidthStyle m430fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.SpacerWidthStyle spacerWidthStyle) {
        if (spacerWidthStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, spacerWidthStyle.getBase());
        tVar.y();
    }
}
