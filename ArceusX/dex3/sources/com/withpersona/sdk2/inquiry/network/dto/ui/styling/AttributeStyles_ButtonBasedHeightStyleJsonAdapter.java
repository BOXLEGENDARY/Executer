...
public final class AttributeStyles_ButtonBasedHeightStyleJsonAdapter extends h<AttributeStyles.ButtonBasedHeightStyle> {
    ...
    public AttributeStyles_ButtonBasedHeightStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ButtonBasedHeightStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ButtonBasedHeightStyle m318fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ButtonBasedHeightStyle buttonBasedHeightStyle) {
        if (buttonBasedHeightStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, buttonBasedHeightStyle.getBase());
        tVar.y();
    }
}
