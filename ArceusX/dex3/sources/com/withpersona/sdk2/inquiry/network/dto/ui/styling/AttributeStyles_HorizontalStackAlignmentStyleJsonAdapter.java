...
public final class AttributeStyles_HorizontalStackAlignmentStyleJsonAdapter extends h<AttributeStyles.HorizontalStackAlignmentStyle> {
    ...
    public AttributeStyles_HorizontalStackAlignmentStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.HorizontalStackAlignmentStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.HorizontalStackAlignmentStyle m372fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.HorizontalStackAlignmentStyle horizontalStackAlignmentStyle) {
        if (horizontalStackAlignmentStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullablePositionAdapter.toJson(tVar, horizontalStackAlignmentStyle.getBase());
        tVar.y();
    }
}
