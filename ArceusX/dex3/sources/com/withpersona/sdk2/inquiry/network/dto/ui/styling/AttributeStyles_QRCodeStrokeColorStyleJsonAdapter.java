...
public final class AttributeStyles_QRCodeStrokeColorStyleJsonAdapter extends h<AttributeStyles.QRCodeStrokeColorStyle> {
    ...
    public AttributeStyles_QRCodeStrokeColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.QRCodeStrokeColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.QRCodeStrokeColorStyle m421fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.QRCodeStrokeColorStyle qRCodeStrokeColorStyle) {
        if (qRCodeStrokeColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableSimpleElementColorAdapter.toJson(tVar, qRCodeStrokeColorStyle.getBase());
        tVar.y();
    }
}
