...
public final class AttributeStyles_HorizontalStackPaddingStyleJsonAdapter extends h<AttributeStyles.HorizontalStackPaddingStyle> {
    ...
    public AttributeStyles_HorizontalStackPaddingStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.HorizontalStackPaddingStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.HorizontalStackPaddingStyle m381fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.HorizontalStackPaddingStyle horizontalStackPaddingStyle) {
        if (horizontalStackPaddingStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementSetAdapter.toJson(tVar, horizontalStackPaddingStyle.getBase());
        tVar.y();
    }
}
