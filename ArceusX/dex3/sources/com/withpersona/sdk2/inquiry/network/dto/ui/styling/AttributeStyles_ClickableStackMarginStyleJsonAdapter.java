...
public final class AttributeStyles_ClickableStackMarginStyleJsonAdapter extends h<AttributeStyles.ClickableStackMarginStyle> {
    ...
    public AttributeStyles_ClickableStackMarginStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ClickableStackMarginStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ClickableStackMarginStyle m334fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ClickableStackMarginStyle clickableStackMarginStyle) {
        if (clickableStackMarginStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementSetAdapter.toJson(tVar, clickableStackMarginStyle.getBase());
        tVar.y();
    }
}
