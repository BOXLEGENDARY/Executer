...
public final class StepStyles_GovernmentIdStepFillColorJsonAdapter extends h<StepStyles.GovernmentIdStepFillColor> {
    ...
    @NotNull
    private final m.b options = m.b.a(new String[]{"base", "governmentIdSelectOptionIcon", "capturePageHintIcon"});

    public StepStyles_GovernmentIdStepFillColorJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("StepStyles.GovernmentIdStepFillColor");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public StepStyles.GovernmentIdStepFillColor m463fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, StepStyles.GovernmentIdStepFillColor governmentIdStepFillColor) {
        if (governmentIdStepFillColor == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableSimpleElementColorAdapter.toJson(tVar, governmentIdStepFillColor.getBase());
        tVar.Z("governmentIdSelectOptionIcon");
        this.nullableSimpleElementColorAdapter.toJson(tVar, governmentIdStepFillColor.getGovernmentIdSelectOptionIcon());
        tVar.Z("capturePageHintIcon");
        this.nullableSimpleElementColorAdapter.toJson(tVar, governmentIdStepFillColor.getCapturePageHintIcon());
        tVar.y();
    }
}
