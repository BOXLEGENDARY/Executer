...
public final class AttributeStyles_HorizontalStackMarginStyleJsonAdapter extends h<AttributeStyles.HorizontalStackMarginStyle> {
    ...
    public AttributeStyles_HorizontalStackMarginStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.HorizontalStackMarginStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.HorizontalStackMarginStyle m380fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.HorizontalStackMarginStyle horizontalStackMarginStyle) {
        if (horizontalStackMarginStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementSetAdapter.toJson(tVar, horizontalStackMarginStyle.getBase());
        tVar.y();
    }
}
