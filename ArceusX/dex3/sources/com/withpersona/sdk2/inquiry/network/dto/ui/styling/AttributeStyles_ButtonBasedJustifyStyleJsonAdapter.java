...
public final class AttributeStyles_ButtonBasedJustifyStyleJsonAdapter extends h<AttributeStyles.ButtonBasedJustifyStyle> {
    ...
    public AttributeStyles_ButtonBasedJustifyStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ButtonBasedJustifyStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ButtonBasedJustifyStyle m319fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ButtonBasedJustifyStyle buttonBasedJustifyStyle) {
        if (buttonBasedJustifyStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullablePositionAdapter.toJson(tVar, buttonBasedJustifyStyle.getBase());
        tVar.y();
    }
}
