...
public final class AttributeStyles_ClickableStackGapStyleJsonAdapter extends h<AttributeStyles.ClickableStackGapStyle> {
    ...
    public AttributeStyles_ClickableStackGapStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ClickableStackGapStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ClickableStackGapStyle m333fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ClickableStackGapStyle clickableStackGapStyle) {
        if (clickableStackGapStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, clickableStackGapStyle.getBase());
        tVar.y();
    }
}
