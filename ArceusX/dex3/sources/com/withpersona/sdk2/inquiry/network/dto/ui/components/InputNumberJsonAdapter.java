...
public final class InputNumberJsonAdapter extends h<InputNumber> {

    @NotNull
    private final h<InputNumber.Attributes> nullableAttributesAdapter;
    ...
    public InputNumberJsonAdapter(@NotNull w wVar) {
        this.stringAdapter = wVar.f(String.class, L.d(), "name");
        this.nullableAttributesAdapter = wVar.f(InputNumber.Attributes.class, L.d(), "attributes");
    ...
    @NotNull
    public InputNumber m271fromJson(@NotNull m mVar) throws j {
        mVar.e();
        String str = null;
        ...
        while (mVar.u()) {
            ...
            if (iP0 == -1) {
                ...
                attributes = (InputNumber.Attributes) this.nullableAttributesAdapter.fromJson(mVar);
            } else if (iP0 == 2) {
    ...
    public void toJson(@NotNull t tVar, InputNumber inputNumber) {
        if (inputNumber == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("name");
        this.stringAdapter.toJson(tVar, inputNumber.getName());
        tVar.Z("attributes");
        this.nullableAttributesAdapter.toJson(tVar, inputNumber.getAttributes());
        tVar.Z("styles");
        this.nullableInputTextBasedComponentStyleAdapter.toJson(tVar, inputNumber.getStyles());
        tVar.y();
    }
}
