...
public final class AttributeStyles_DateSelectBorderColorStyleJsonAdapter extends h<AttributeStyles.DateSelectBorderColorStyle> {
    ...
    public AttributeStyles_DateSelectBorderColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.DateSelectBorderColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.DateSelectBorderColorStyle m344fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.DateSelectBorderColorStyle dateSelectBorderColorStyle) {
        if (dateSelectBorderColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableComplexElementColorAdapter.toJson(tVar, dateSelectBorderColorStyle.getBase());
        tVar.y();
    }
}
