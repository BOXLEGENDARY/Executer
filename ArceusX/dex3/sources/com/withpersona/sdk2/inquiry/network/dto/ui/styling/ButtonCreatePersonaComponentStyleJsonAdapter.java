...
public final class ButtonCreatePersonaComponentStyleJsonAdapter extends h<ButtonCreatePersonaComponentStyle> {
    ...
    public ButtonCreatePersonaComponentStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("ButtonCreatePersonaComponentStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public ButtonCreatePersonaComponentStyle m443fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, ButtonCreatePersonaComponentStyle buttonCreatePersonaComponentStyle) {
        if (buttonCreatePersonaComponentStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("padding");
        this.nullableButtonBasedPaddingStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getPadding());
        tVar.Z("margin");
        this.nullableButtonBasedMarginStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getMargin());
        tVar.Z("justify");
        this.nullableButtonBasedJustifyStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getJustify());
        tVar.Z("fontFamily");
        this.nullableButtonBasedFontFamilyStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getFontFamily());
        tVar.Z("fontSize");
        this.nullableButtonBasedFontSizeStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getFontSize());
        tVar.Z("fontWeight");
        this.nullableButtonBasedFontWeightStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getFontWeight());
        tVar.Z("letterSpacing");
        this.nullableButtonBasedLetterSpacingStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getLetterSpacing());
        tVar.Z("lineHeight");
        this.nullableButtonBasedLineHeightStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getLineHeight());
        tVar.Z("textColor");
        this.nullableButtonBasedTextColorStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getTextColor());
        tVar.Z("height");
        this.nullableButtonBasedHeightStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getHeight());
        tVar.Z("width");
        this.nullableButtonBasedWidthStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getWidth());
        tVar.Z("backgroundColor");
        this.nullableButtonBasedBackgroundColorStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getBackgroundColor());
        tVar.Z("borderColor");
        this.nullableButtonBasedBorderColorStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getBorderColor());
        tVar.Z("borderRadius");
        this.nullableButtonBasedBorderRadiusStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getBorderRadius());
        tVar.Z("borderWidth");
        this.nullableButtonBasedBorderWidthStyleAdapter.toJson(tVar, buttonCreatePersonaComponentStyle.getBorderWidth());
        tVar.y();
    }
}
