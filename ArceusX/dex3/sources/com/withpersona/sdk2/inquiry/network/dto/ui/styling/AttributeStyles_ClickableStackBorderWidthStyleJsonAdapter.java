...
public final class AttributeStyles_ClickableStackBorderWidthStyleJsonAdapter extends h<AttributeStyles.ClickableStackBorderWidthStyle> {
    ...
    public AttributeStyles_ClickableStackBorderWidthStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ClickableStackBorderWidthStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ClickableStackBorderWidthStyle m331fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ClickableStackBorderWidthStyle clickableStackBorderWidthStyle) {
        if (clickableStackBorderWidthStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementSetAdapter.toJson(tVar, clickableStackBorderWidthStyle.getBase());
        tVar.y();
    }
}
