...
public final class AttributeStyles_InputCheckboxTextColorStyleJsonAdapter extends h<AttributeStyles.InputCheckboxTextColorStyle> {
    ...
    public AttributeStyles_InputCheckboxTextColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputCheckboxTextColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputCheckboxTextColorStyle m388fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputCheckboxTextColorStyle inputCheckboxTextColorStyle) {
        if (inputCheckboxTextColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableSimpleElementColorAdapter.toJson(tVar, inputCheckboxTextColorStyle.getBase());
        tVar.Z("description");
        this.nullableSimpleElementColorAdapter.toJson(tVar, inputCheckboxTextColorStyle.getDescription());
        tVar.Z("error");
        this.nullableSimpleElementColorAdapter.toJson(tVar, inputCheckboxTextColorStyle.getError());
        tVar.y();
    }
}
