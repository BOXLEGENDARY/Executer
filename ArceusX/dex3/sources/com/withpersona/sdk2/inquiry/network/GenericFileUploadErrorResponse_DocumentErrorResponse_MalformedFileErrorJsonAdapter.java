...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedFileErrorJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedFileError> {
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedFileErrorJsonAdapter(@NotNull w wVar) {
        ...
        this.detailsAdapter = wVar.f(GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedFileError.Details.class, L.d(), "details");
    }
    ...
    @NotNull
    public GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedFileError m109fromJson(@NotNull m mVar) throws j {
        mVar.e();
        String str = null;
        String str2 = null;
        ...
        while (mVar.u()) {
            ...
            } else if (iP0 == 2 && (details = (GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedFileError.Details) this.detailsAdapter.fromJson(mVar)) == null) {
