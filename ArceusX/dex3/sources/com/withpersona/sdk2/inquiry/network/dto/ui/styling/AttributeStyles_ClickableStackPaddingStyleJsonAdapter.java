...
public final class AttributeStyles_ClickableStackPaddingStyleJsonAdapter extends h<AttributeStyles.ClickableStackPaddingStyle> {
    ...
    public AttributeStyles_ClickableStackPaddingStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ClickableStackPaddingStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ClickableStackPaddingStyle m335fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ClickableStackPaddingStyle clickableStackPaddingStyle) {
        if (clickableStackPaddingStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementSetAdapter.toJson(tVar, clickableStackPaddingStyle.getBase());
        tVar.y();
    }
}
