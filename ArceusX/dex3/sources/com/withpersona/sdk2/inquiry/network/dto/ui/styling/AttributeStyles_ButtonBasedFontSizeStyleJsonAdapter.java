...
public final class AttributeStyles_ButtonBasedFontSizeStyleJsonAdapter extends h<AttributeStyles.ButtonBasedFontSizeStyle> {
    ...
    public AttributeStyles_ButtonBasedFontSizeStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ButtonBasedFontSizeStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ButtonBasedFontSizeStyle m316fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ButtonBasedFontSizeStyle buttonBasedFontSizeStyle) {
        if (buttonBasedFontSizeStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, buttonBasedFontSizeStyle.getBase());
        tVar.y();
    }
}
