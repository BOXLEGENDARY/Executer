...
public final class NextStep_Document_Pages_UploadOptionsDialog_ComponentNameMappingJsonAdapter extends h<NextStep.Document.Pages.UploadOptionsDialog.ComponentNameMapping> {
    ...
    @NotNull
    private final m.b options = m.b.a(new String[]{"buttonFilePicker", "buttonPhotoLibrary", "buttonCamera", "buttonCancel"});

    public NextStep_Document_Pages_UploadOptionsDialog_ComponentNameMappingJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("NextStep.Document.Pages.UploadOptionsDialog.ComponentNameMapping");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public NextStep.Document.Pages.UploadOptionsDialog.ComponentNameMapping m162fromJson(@NotNull m mVar) {
        mVar.e();
        String str = null;
        String str2 = null;
        String str3 = null;
    ...
    public void toJson(@NotNull t tVar, NextStep.Document.Pages.UploadOptionsDialog.ComponentNameMapping componentNameMapping) {
        ...
        tVar.Z("buttonCancel");
        this.nullableStringAdapter.toJson(tVar, componentNameMapping.getButtonCancel());
        tVar.y();
    }
}
