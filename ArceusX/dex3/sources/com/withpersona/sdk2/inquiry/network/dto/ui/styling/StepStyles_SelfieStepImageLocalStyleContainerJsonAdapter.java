...
public final class StepStyles_SelfieStepImageLocalStyleContainerJsonAdapter extends h<StepStyles.SelfieStepImageLocalStyleContainer> {
    ...
    public StepStyles_SelfieStepImageLocalStyleContainerJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("StepStyles.SelfieStepImageLocalStyleContainer");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public StepStyles.SelfieStepImageLocalStyleContainer m478fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, StepStyles.SelfieStepImageLocalStyleContainer selfieStepImageLocalStyleContainer) {
        if (selfieStepImageLocalStyleContainer == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableLocalImageComponentStyleAdapter.toJson(tVar, selfieStepImageLocalStyleContainer.getBase());
        tVar.y();
    }
}
