...
public final class AttributeStyles_FooterBorderWidthStyleJsonAdapter extends h<AttributeStyles.FooterBorderWidthStyle> {
    ...
    public AttributeStyles_FooterBorderWidthStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.FooterBorderWidthStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.FooterBorderWidthStyle m362fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.FooterBorderWidthStyle footerBorderWidthStyle) {
        if (footerBorderWidthStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementSetAdapter.toJson(tVar, footerBorderWidthStyle.getBase());
        tVar.y();
    }
}
