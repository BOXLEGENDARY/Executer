...
public final class Title_AttributesJsonAdapter extends h<Title.Attributes> {
    ...
    public Title_AttributesJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("Title.Attributes");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public Title.Attributes m306fromJson(@NotNull m mVar) throws j, NoSuchMethodException, SecurityException {
        mVar.e();
        String str = null;
        ...
        Constructor<Title.Attributes> declaredConstructor = this.constructorRef;
        if (declaredConstructor == null) {
            declaredConstructor = Title.Attributes.class.getDeclaredConstructor(String.class, JsonLogicBoolean.class, JsonLogicBoolean.class, Integer.TYPE, c.c);
    ...
    public void toJson(@NotNull t tVar, Title.Attributes attributes) {
        if (attributes == null) {
