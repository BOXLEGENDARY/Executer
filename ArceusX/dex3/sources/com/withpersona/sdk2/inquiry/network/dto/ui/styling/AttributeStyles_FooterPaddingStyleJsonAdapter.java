...
public final class AttributeStyles_FooterPaddingStyleJsonAdapter extends h<AttributeStyles.FooterPaddingStyle> {
    ...
    public AttributeStyles_FooterPaddingStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.FooterPaddingStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.FooterPaddingStyle m364fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.FooterPaddingStyle footerPaddingStyle) {
        if (footerPaddingStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementSetAdapter.toJson(tVar, footerPaddingStyle.getBase());
        tVar.y();
    }
}
