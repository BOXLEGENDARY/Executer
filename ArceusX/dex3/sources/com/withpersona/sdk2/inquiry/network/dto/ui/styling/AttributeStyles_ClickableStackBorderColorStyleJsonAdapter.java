...
public final class AttributeStyles_ClickableStackBorderColorStyleJsonAdapter extends h<AttributeStyles.ClickableStackBorderColorStyle> {
    ...
    public AttributeStyles_ClickableStackBorderColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ClickableStackBorderColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ClickableStackBorderColorStyle m329fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ClickableStackBorderColorStyle clickableStackBorderColorStyle) {
        if (clickableStackBorderColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableComplexElementColorAdapter.toJson(tVar, clickableStackBorderColorStyle.getBase());
        tVar.y();
    }
}
