...
public final class AttributeStyles_ComplexTextBasedLineHeightStyleJsonAdapter extends h<AttributeStyles.ComplexTextBasedLineHeightStyle> {
    ...
    public AttributeStyles_ComplexTextBasedLineHeightStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ComplexTextBasedLineHeightStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ComplexTextBasedLineHeightStyle m341fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ComplexTextBasedLineHeightStyle complexTextBasedLineHeightStyle) {
        if (complexTextBasedLineHeightStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("value");
        this.nullableMeasurementAdapter.toJson(tVar, complexTextBasedLineHeightStyle.getValue());
        tVar.Z("placeholder");
        this.nullableMeasurementAdapter.toJson(tVar, complexTextBasedLineHeightStyle.getPlaceholder());
        tVar.Z("label");
        this.nullableMeasurementAdapter.toJson(tVar, complexTextBasedLineHeightStyle.getLabel());
        tVar.Z("error");
        this.nullableMeasurementAdapter.toJson(tVar, complexTextBasedLineHeightStyle.getError());
        tVar.y();
    }
}
