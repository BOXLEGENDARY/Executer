...
public final class StepStyles_StepSubmitButtonComponentStyleContainerJsonAdapter extends h<StepStyles.StepSubmitButtonComponentStyleContainer> {
    ...
    public StepStyles_StepSubmitButtonComponentStyleContainerJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("StepStyles.StepSubmitButtonComponentStyleContainer");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public StepStyles.StepSubmitButtonComponentStyleContainer m494fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, StepStyles.StepSubmitButtonComponentStyleContainer stepSubmitButtonComponentStyleContainer) {
        if (stepSubmitButtonComponentStyleContainer == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableButtonSubmitComponentStyleAdapter.toJson(tVar, stepSubmitButtonComponentStyleContainer.getBase());
        tVar.y();
    }
}
