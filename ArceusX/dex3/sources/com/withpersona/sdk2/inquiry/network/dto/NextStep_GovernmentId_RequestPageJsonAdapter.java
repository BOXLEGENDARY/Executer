...
public final class NextStep_GovernmentId_RequestPageJsonAdapter extends h<NextStep.GovernmentId.RequestPage> {
    ...
    @NotNull
    private final m.b options = m.b.a(new String[]{"titleFront", "titleBack", "titlePdf417", "titlePassportSignature", "descriptionFront", "descriptionBack", "descriptionPdf417", "descriptionPassportSignature", "choosePhotoButtonText", "liveUploadButtonText"});

    @NotNull
    private final h<String> stringAdapter;

    public NextStep_GovernmentId_RequestPageJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("NextStep.GovernmentId.RequestPage");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public NextStep.GovernmentId.RequestPage m183fromJson(@NotNull m mVar) throws j {
        mVar.e();
        String str = null;
        String str2 = null;
        String str3 = null;
        ...
        while (true) {
            ...
            if (!mVar.u()) {
                ...
                if (str12 == null) {
                    throw c.o("choosePhotoButtonText", "choosePhotoButtonText", mVar);
                }
                if (str11 != null) {
                    return new NextStep.GovernmentId.RequestPage(str, str2, str3, str17, str16, str15, str14, str13, str12, str11);
                }
                throw c.o("liveUploadButtonText", "liveUploadButtonText", mVar);
            }
            switch (mVar.P0(this.options)) {
                ...
                case R.styleable.LottieAnimationView_lottie_loop:
                    ...
                    if (str9 == null) {
                        throw c.x("choosePhotoButtonText", "choosePhotoButtonText", mVar);
                    }
                    str10 = str11;
                    str8 = str13;
                    str7 = str14;
                ...
                case R.styleable.LottieAnimationView_lottie_progress:
                    ...
                    if (str10 == null) {
                        throw c.x("liveUploadButtonText", "liveUploadButtonText", mVar);
                    }
                    str9 = str12;
                    str8 = str13;
                    str7 = str14;
    ...
    public void toJson(@NotNull t tVar, NextStep.GovernmentId.RequestPage requestPage) {
        if (requestPage == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("titleFront");
        this.stringAdapter.toJson(tVar, requestPage.getTitleFront());
        tVar.Z("titleBack");
        this.stringAdapter.toJson(tVar, requestPage.getTitleBack());
        tVar.Z("titlePdf417");
        this.stringAdapter.toJson(tVar, requestPage.getTitlePdf417());
        tVar.Z("titlePassportSignature");
        this.stringAdapter.toJson(tVar, requestPage.getTitlePassportSignature());
        tVar.Z("descriptionFront");
        this.stringAdapter.toJson(tVar, requestPage.getDescriptionFront());
        tVar.Z("descriptionBack");
        this.stringAdapter.toJson(tVar, requestPage.getDescriptionBack());
        tVar.Z("descriptionPdf417");
        this.stringAdapter.toJson(tVar, requestPage.getDescriptionPdf417());
        tVar.Z("descriptionPassportSignature");
        this.stringAdapter.toJson(tVar, requestPage.getDescriptionPassportSignature());
        tVar.Z("choosePhotoButtonText");
        this.stringAdapter.toJson(tVar, requestPage.getChoosePhotoButtonText());
        tVar.Z("liveUploadButtonText");
        this.stringAdapter.toJson(tVar, requestPage.getLiveUploadButtonText());
        tVar.y();
    }
}
