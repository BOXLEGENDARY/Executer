...
public final class AttributeStyles_TextBasedFontWeightStyleJsonAdapter extends h<AttributeStyles.TextBasedFontWeightStyle> {
    ...
    public AttributeStyles_TextBasedFontWeightStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.TextBasedFontWeightStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.TextBasedFontWeightStyle m433fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.TextBasedFontWeightStyle textBasedFontWeightStyle) {
        if (textBasedFontWeightStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableFontWeightContainerAdapter.toJson(tVar, textBasedFontWeightStyle.getBase());
        tVar.y();
    }
}
