...
public final class AttributeStyles_ESignaturePrimaryButtonStylesContainerJsonAdapter extends h<AttributeStyles.ESignaturePrimaryButtonStylesContainer> {
    ...
    public AttributeStyles_ESignaturePrimaryButtonStylesContainerJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ESignaturePrimaryButtonStylesContainer");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ESignaturePrimaryButtonStylesContainer m355fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ESignaturePrimaryButtonStylesContainer eSignaturePrimaryButtonStylesContainer) {
        if (eSignaturePrimaryButtonStylesContainer == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableButtonSubmitComponentStyleAdapter.toJson(tVar, eSignaturePrimaryButtonStylesContainer.getBase());
        tVar.y();
    }
}
