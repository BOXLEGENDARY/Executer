...
public final class AttributeStyles_InputSelectTextFontSizeStyleJsonAdapter extends h<AttributeStyles.InputSelectTextFontSizeStyle> {
    ...
    public AttributeStyles_InputSelectTextFontSizeStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputSelectTextFontSizeStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputSelectTextFontSizeStyle m403fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputSelectTextFontSizeStyle inputSelectTextFontSizeStyle) {
        if (inputSelectTextFontSizeStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, inputSelectTextFontSizeStyle.getBase());
        tVar.Z("label");
        this.nullableMeasurementAdapter.toJson(tVar, inputSelectTextFontSizeStyle.getLabel());
        tVar.Z("error");
        this.nullableMeasurementAdapter.toJson(tVar, inputSelectTextFontSizeStyle.getError());
        tVar.y();
    }
}
