...
public final class InputConfirmationCode_AttributesJsonAdapter extends h<InputConfirmationCode.Attributes> {
    ...
    public InputConfirmationCode_AttributesJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("InputConfirmationCode.Attributes");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public InputConfirmationCode.Attributes m257fromJson(@NotNull m mVar) {
        mVar.e();
        String str = null;
        String str2 = null;
        String str3 = null;
    ...
    public void toJson(@NotNull t tVar, InputConfirmationCode.Attributes attributes) {
        if (attributes == null) {
