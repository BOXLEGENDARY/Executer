...
public final class AttributeStyles_QRCodeFillColorStyleJsonAdapter extends h<AttributeStyles.QRCodeFillColorStyle> {
    ...
    public AttributeStyles_QRCodeFillColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.QRCodeFillColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.QRCodeFillColorStyle m418fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.QRCodeFillColorStyle qRCodeFillColorStyle) {
        if (qRCodeFillColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableSimpleElementColorAdapter.toJson(tVar, qRCodeFillColorStyle.getBase());
        tVar.y();
    }
}
