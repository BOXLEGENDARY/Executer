...
public final class ButtonCombinedStepComponentStyleJsonAdapter extends h<ButtonCombinedStepComponentStyle> {
    ...
    public ButtonCombinedStepComponentStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("ButtonCombinedStepComponentStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public ButtonCombinedStepComponentStyle m441fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, ButtonCombinedStepComponentStyle buttonCombinedStepComponentStyle) {
        if (buttonCombinedStepComponentStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("padding");
        this.nullableButtonBasedPaddingStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getPadding());
        tVar.Z("margin");
        this.nullableButtonBasedMarginStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getMargin());
        tVar.Z("justify");
        this.nullableButtonBasedJustifyStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getJustify());
        tVar.Z("fontFamily");
        this.nullableButtonBasedFontFamilyStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getFontFamily());
        tVar.Z("fontSize");
        this.nullableButtonBasedFontSizeStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getFontSize());
        tVar.Z("fontWeight");
        this.nullableButtonBasedFontWeightStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getFontWeight());
        tVar.Z("letterSpacing");
        this.nullableButtonBasedLetterSpacingStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getLetterSpacing());
        tVar.Z("lineHeight");
        this.nullableButtonBasedLineHeightStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getLineHeight());
        tVar.Z("textColor");
        this.nullableButtonBasedTextColorStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getTextColor());
        tVar.Z("height");
        this.nullableButtonBasedHeightStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getHeight());
        tVar.Z("width");
        this.nullableButtonBasedWidthStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getWidth());
        tVar.Z("backgroundColor");
        this.nullableButtonBasedBackgroundColorStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getBackgroundColor());
        tVar.Z("borderColor");
        this.nullableButtonBasedBorderColorStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getBorderColor());
        tVar.Z("borderRadius");
        this.nullableButtonBasedBorderRadiusStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getBorderRadius());
        tVar.Z("borderWidth");
        this.nullableButtonBasedBorderWidthStyleAdapter.toJson(tVar, buttonCombinedStepComponentStyle.getBorderWidth());
        tVar.y();
    }
}
