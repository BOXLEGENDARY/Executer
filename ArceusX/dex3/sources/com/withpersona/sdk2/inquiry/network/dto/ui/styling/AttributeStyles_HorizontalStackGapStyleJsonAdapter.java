...
public final class AttributeStyles_HorizontalStackGapStyleJsonAdapter extends h<AttributeStyles.HorizontalStackGapStyle> {
    ...
    public AttributeStyles_HorizontalStackGapStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.HorizontalStackGapStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.HorizontalStackGapStyle m379fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.HorizontalStackGapStyle horizontalStackGapStyle) {
        if (horizontalStackGapStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, horizontalStackGapStyle.getBase());
        tVar.y();
    }
}
