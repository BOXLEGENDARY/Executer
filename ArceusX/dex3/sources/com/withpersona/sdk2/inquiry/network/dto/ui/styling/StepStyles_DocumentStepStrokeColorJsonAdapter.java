...
public final class StepStyles_DocumentStepStrokeColorJsonAdapter extends h<StepStyles.DocumentStepStrokeColor> {
    ...
    @NotNull
    private final m.b options = m.b.a(new String[]{"base", "imagePreviewPlusIcon", "imagePreviewXIcon"});

    public StepStyles_DocumentStepStrokeColorJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("StepStyles.DocumentStepStrokeColor");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public StepStyles.DocumentStepStrokeColor m456fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, StepStyles.DocumentStepStrokeColor documentStepStrokeColor) {
        if (documentStepStrokeColor == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableSimpleElementColorAdapter.toJson(tVar, documentStepStrokeColor.getBase());
        tVar.Z("imagePreviewPlusIcon");
        this.nullableSimpleElementColorAdapter.toJson(tVar, documentStepStrokeColor.getImagePreviewPlusIcon());
        tVar.Z("imagePreviewXIcon");
        this.nullableSimpleElementColorAdapter.toJson(tVar, documentStepStrokeColor.getImagePreviewXIcon());
        tVar.y();
    }
}
