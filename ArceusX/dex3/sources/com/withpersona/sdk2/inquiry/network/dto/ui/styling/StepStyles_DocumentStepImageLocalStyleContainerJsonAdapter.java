...
public final class StepStyles_DocumentStepImageLocalStyleContainerJsonAdapter extends h<StepStyles.DocumentStepImageLocalStyleContainer> {
    ...
    public StepStyles_DocumentStepImageLocalStyleContainerJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("StepStyles.DocumentStepImageLocalStyleContainer");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public StepStyles.DocumentStepImageLocalStyleContainer m454fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, StepStyles.DocumentStepImageLocalStyleContainer documentStepImageLocalStyleContainer) {
        if (documentStepImageLocalStyleContainer == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableLocalImageComponentStyleAdapter.toJson(tVar, documentStepImageLocalStyleContainer.getBase());
        tVar.y();
    }
}
