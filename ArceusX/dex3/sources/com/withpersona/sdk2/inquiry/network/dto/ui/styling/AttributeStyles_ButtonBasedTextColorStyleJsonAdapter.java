...
public final class AttributeStyles_ButtonBasedTextColorStyleJsonAdapter extends h<AttributeStyles.ButtonBasedTextColorStyle> {
    ...
    public AttributeStyles_ButtonBasedTextColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ButtonBasedTextColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ButtonBasedTextColorStyle m324fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ButtonBasedTextColorStyle buttonBasedTextColorStyle) {
        if (buttonBasedTextColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableComplexElementColorAdapter.toJson(tVar, buttonBasedTextColorStyle.getBase());
        tVar.y();
    }
}
