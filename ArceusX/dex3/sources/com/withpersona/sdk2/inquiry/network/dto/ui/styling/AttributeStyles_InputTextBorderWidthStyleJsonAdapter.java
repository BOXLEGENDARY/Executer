...
public final class AttributeStyles_InputTextBorderWidthStyleJsonAdapter extends h<AttributeStyles.InputTextBorderWidthStyle> {
    ...
    public AttributeStyles_InputTextBorderWidthStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputTextBorderWidthStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputTextBorderWidthStyle m410fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputTextBorderWidthStyle inputTextBorderWidthStyle) {
        if (inputTextBorderWidthStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementSetAdapter.toJson(tVar, inputTextBorderWidthStyle.getBase());
        tVar.y();
    }
}
