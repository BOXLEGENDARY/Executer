...
public final class AttributeStyles_ComplexTextBasedFontFamilyStyleJsonAdapter extends h<AttributeStyles.ComplexTextBasedFontFamilyStyle> {
    ...
    public AttributeStyles_ComplexTextBasedFontFamilyStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ComplexTextBasedFontFamilyStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ComplexTextBasedFontFamilyStyle m337fromJson(@NotNull m mVar) {
        mVar.e();
        ...
        while (mVar.u()) {
            ...
            if (iP0 == -1) {
                ...
                fontName4 = (StyleElements.FontName) this.nullableFontNameAdapter.fromJson(mVar);
            } else if (iP0 == 4) {
                fontName5 = (StyleElements.FontName) this.nullableFontNameAdapter.fromJson(mVar);
            }
        }
        mVar.j();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ComplexTextBasedFontFamilyStyle complexTextBasedFontFamilyStyle) {
        if (complexTextBasedFontFamilyStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableFontNameAdapter.toJson(tVar, complexTextBasedFontFamilyStyle.getBase());
        tVar.Z("value");
        this.nullableFontNameAdapter.toJson(tVar, complexTextBasedFontFamilyStyle.getValue());
        tVar.Z("placeholder");
        this.nullableFontNameAdapter.toJson(tVar, complexTextBasedFontFamilyStyle.getPlaceholder());
        tVar.Z("label");
        this.nullableFontNameAdapter.toJson(tVar, complexTextBasedFontFamilyStyle.getLabel());
        tVar.Z("error");
        this.nullableFontNameAdapter.toJson(tVar, complexTextBasedFontFamilyStyle.getError());
        tVar.y();
    }
}
