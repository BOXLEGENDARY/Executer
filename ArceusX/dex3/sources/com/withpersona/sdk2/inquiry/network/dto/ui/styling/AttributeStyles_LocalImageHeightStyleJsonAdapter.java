...
public final class AttributeStyles_LocalImageHeightStyleJsonAdapter extends h<AttributeStyles.LocalImageHeightStyle> {
    ...
    public AttributeStyles_LocalImageHeightStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.LocalImageHeightStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.LocalImageHeightStyle m413fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.LocalImageHeightStyle localImageHeightStyle) {
        if (localImageHeightStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, localImageHeightStyle.getBase());
        tVar.y();
    }
}
