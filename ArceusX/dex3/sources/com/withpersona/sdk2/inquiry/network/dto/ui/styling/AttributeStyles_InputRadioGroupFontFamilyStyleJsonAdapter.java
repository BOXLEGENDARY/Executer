...
public final class AttributeStyles_InputRadioGroupFontFamilyStyleJsonAdapter extends h<AttributeStyles.InputRadioGroupFontFamilyStyle> {
    ...
    public AttributeStyles_InputRadioGroupFontFamilyStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputRadioGroupFontFamilyStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputRadioGroupFontFamilyStyle m390fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputRadioGroupFontFamilyStyle inputRadioGroupFontFamilyStyle) {
        if (inputRadioGroupFontFamilyStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableFontNameAdapter.toJson(tVar, inputRadioGroupFontFamilyStyle.getBase());
        tVar.Z("description");
        this.nullableFontNameAdapter.toJson(tVar, inputRadioGroupFontFamilyStyle.getDescription());
        tVar.Z("error");
        this.nullableFontNameAdapter.toJson(tVar, inputRadioGroupFontFamilyStyle.getError());
        tVar.y();
    }
}
