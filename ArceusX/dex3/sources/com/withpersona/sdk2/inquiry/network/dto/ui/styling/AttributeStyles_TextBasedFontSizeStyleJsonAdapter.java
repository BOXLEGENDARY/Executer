...
public final class AttributeStyles_TextBasedFontSizeStyleJsonAdapter extends h<AttributeStyles.TextBasedFontSizeStyle> {
    ...
    public AttributeStyles_TextBasedFontSizeStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.TextBasedFontSizeStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.TextBasedFontSizeStyle m432fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.TextBasedFontSizeStyle textBasedFontSizeStyle) {
        if (textBasedFontSizeStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, textBasedFontSizeStyle.getBase());
        tVar.y();
    }
}
