...
public final class AttributeStyles_InputSelectTextLineHeightStyleJsonAdapter extends h<AttributeStyles.InputSelectTextLineHeightStyle> {
    ...
    public AttributeStyles_InputSelectTextLineHeightStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputSelectTextLineHeightStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputSelectTextLineHeightStyle m406fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputSelectTextLineHeightStyle inputSelectTextLineHeightStyle) {
        if (inputSelectTextLineHeightStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, inputSelectTextLineHeightStyle.getBase());
        tVar.Z("label");
        this.nullableMeasurementAdapter.toJson(tVar, inputSelectTextLineHeightStyle.getLabel());
        tVar.Z("error");
        this.nullableMeasurementAdapter.toJson(tVar, inputSelectTextLineHeightStyle.getError());
        tVar.y();
    }
}
