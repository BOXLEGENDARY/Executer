...
public final class AttributeStyles_ESignatureSecondaryButtonStylesContainerJsonAdapter extends h<AttributeStyles.ESignatureSecondaryButtonStylesContainer> {
    ...
    public AttributeStyles_ESignatureSecondaryButtonStylesContainerJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ESignatureSecondaryButtonStylesContainer");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ESignatureSecondaryButtonStylesContainer m357fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ESignatureSecondaryButtonStylesContainer eSignatureSecondaryButtonStylesContainer) {
        if (eSignatureSecondaryButtonStylesContainer == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableButtonCancelComponentStyleAdapter.toJson(tVar, eSignatureSecondaryButtonStylesContainer.getBase());
        tVar.y();
    }
}
