...
public final class AttributeStyles_InputTextBorderColorStyleJsonAdapter extends h<AttributeStyles.InputTextBorderColorStyle> {
    ...
    public AttributeStyles_InputTextBorderColorStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputTextBorderColorStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputTextBorderColorStyle m408fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputTextBorderColorStyle inputTextBorderColorStyle) {
        if (inputTextBorderColorStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableComplexElementColorAdapter.toJson(tVar, inputTextBorderColorStyle.getBase());
        tVar.y();
    }
}
