...
public final class AttributeStyles_ClickableStackAlignmentStyleJsonAdapter extends h<AttributeStyles.ClickableStackAlignmentStyle> {
    ...
    public AttributeStyles_ClickableStackAlignmentStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.ClickableStackAlignmentStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.ClickableStackAlignmentStyle m326fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.ClickableStackAlignmentStyle clickableStackAlignmentStyle) {
        if (clickableStackAlignmentStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullablePositionAdapter.toJson(tVar, clickableStackAlignmentStyle.getBase());
        tVar.y();
    }
}
