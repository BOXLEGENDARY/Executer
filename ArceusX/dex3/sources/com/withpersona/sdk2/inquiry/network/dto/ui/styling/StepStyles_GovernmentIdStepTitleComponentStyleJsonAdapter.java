...
public final class StepStyles_GovernmentIdStepTitleComponentStyleJsonAdapter extends h<StepStyles.GovernmentIdStepTitleComponentStyle> {
    ...
    @NotNull
    private final m.b options = m.b.a(new String[]{"base", "governmentIdProcessingTitle"});

    public StepStyles_GovernmentIdStepTitleComponentStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("StepStyles.GovernmentIdStepTitleComponentStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public StepStyles.GovernmentIdStepTitleComponentStyle m473fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, StepStyles.GovernmentIdStepTitleComponentStyle governmentIdStepTitleComponentStyle) {
        if (governmentIdStepTitleComponentStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableStepTextBasedComponentStyleContainerAdapter.toJson(tVar, governmentIdStepTitleComponentStyle.getBase());
        tVar.Z("governmentIdProcessingTitle");
        this.nullableStepTextBasedComponentStyleContainerAdapter.toJson(tVar, governmentIdStepTitleComponentStyle.getGovernmentIdProcessingTitle());
        tVar.y();
    }
}
