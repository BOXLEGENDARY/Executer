...
public final class StepStyles_SelfieStepTitleComponentStyleJsonAdapter extends h<StepStyles.SelfieStepTitleComponentStyle> {
    ...
    @NotNull
    private final m.b options = m.b.a(new String[]{"base", "selfieProcessingTitle"});

    public StepStyles_SelfieStepTitleComponentStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("StepStyles.SelfieStepTitleComponentStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public StepStyles.SelfieStepTitleComponentStyle m483fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, StepStyles.SelfieStepTitleComponentStyle selfieStepTitleComponentStyle) {
        if (selfieStepTitleComponentStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableStepTextBasedComponentStyleContainerAdapter.toJson(tVar, selfieStepTitleComponentStyle.getBase());
        tVar.Z("selfieProcessingTitle");
        this.nullableStepTextBasedComponentStyleContainerAdapter.toJson(tVar, selfieStepTitleComponentStyle.getSelfieProcessingTitle());
        tVar.y();
    }
}
