...
public final class AttributeStyles_LocalImageJustifyStyleJsonAdapter extends h<AttributeStyles.LocalImageJustifyStyle> {
    ...
    public AttributeStyles_LocalImageJustifyStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.LocalImageJustifyStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.LocalImageJustifyStyle m414fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.LocalImageJustifyStyle localImageJustifyStyle) {
        if (localImageJustifyStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullablePositionAdapter.toJson(tVar, localImageJustifyStyle.getBase());
        tVar.y();
    }
}
