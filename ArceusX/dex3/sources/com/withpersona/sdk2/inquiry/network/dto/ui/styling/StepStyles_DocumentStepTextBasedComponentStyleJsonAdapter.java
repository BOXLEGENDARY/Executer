...
public final class StepStyles_DocumentStepTextBasedComponentStyleJsonAdapter extends h<StepStyles.DocumentStepTextBasedComponentStyle> {
    ...
    @NotNull
    private final m.b options = m.b.a(new String[]{"base", "documentProcessingText", "imageName"});

    public StepStyles_DocumentStepTextBasedComponentStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("StepStyles.DocumentStepTextBasedComponentStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public StepStyles.DocumentStepTextBasedComponentStyle m458fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, StepStyles.DocumentStepTextBasedComponentStyle documentStepTextBasedComponentStyle) {
        if (documentStepTextBasedComponentStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableStepTextBasedComponentStyleContainerAdapter.toJson(tVar, documentStepTextBasedComponentStyle.getBase());
        tVar.Z("documentProcessingText");
        this.nullableStepTextBasedComponentStyleContainerAdapter.toJson(tVar, documentStepTextBasedComponentStyle.getDocumentProcessingText());
        tVar.Z("imageName");
        this.nullableStepTextBasedComponentStyleContainerAdapter.toJson(tVar, documentStepTextBasedComponentStyle.getImageName());
        tVar.y();
    }
}
