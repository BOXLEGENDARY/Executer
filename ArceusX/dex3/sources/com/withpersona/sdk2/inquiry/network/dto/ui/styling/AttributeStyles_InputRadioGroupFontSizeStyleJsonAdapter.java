...
public final class AttributeStyles_InputRadioGroupFontSizeStyleJsonAdapter extends h<AttributeStyles.InputRadioGroupFontSizeStyle> {
    ...
    public AttributeStyles_InputRadioGroupFontSizeStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputRadioGroupFontSizeStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputRadioGroupFontSizeStyle m391fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputRadioGroupFontSizeStyle inputRadioGroupFontSizeStyle) {
        if (inputRadioGroupFontSizeStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, inputRadioGroupFontSizeStyle.getBase());
        tVar.Z("description");
        this.nullableMeasurementAdapter.toJson(tVar, inputRadioGroupFontSizeStyle.getDescription());
        tVar.Z("error");
        this.nullableMeasurementAdapter.toJson(tVar, inputRadioGroupFontSizeStyle.getError());
        tVar.y();
    }
}
