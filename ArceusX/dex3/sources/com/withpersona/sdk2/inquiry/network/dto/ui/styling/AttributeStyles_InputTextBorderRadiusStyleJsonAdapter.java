...
public final class AttributeStyles_InputTextBorderRadiusStyleJsonAdapter extends h<AttributeStyles.InputTextBorderRadiusStyle> {
    ...
    public AttributeStyles_InputTextBorderRadiusStyleJsonAdapter(@NotNull w wVar) {
    ...
    public String toString() {
        ...
        sb.append("AttributeStyles.InputTextBorderRadiusStyle");
        sb.append(')');
        return sb.toString();
    }

    @NotNull
    public AttributeStyles.InputTextBorderRadiusStyle m409fromJson(@NotNull m mVar) {
        mVar.e();
    ...
    public void toJson(@NotNull t tVar, AttributeStyles.InputTextBorderRadiusStyle inputTextBorderRadiusStyle) {
        if (inputTextBorderRadiusStyle == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        tVar.f();
        tVar.Z("base");
        this.nullableMeasurementAdapter.toJson(tVar, inputTextBorderRadiusStyle.getBase());
        tVar.y();
    }
}
