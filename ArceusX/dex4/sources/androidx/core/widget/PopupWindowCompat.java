...
public final class PopupWindowCompat {
    ...
    public static void setOverlapAnchor(@NonNull PopupWindow popupWindow, boolean overlapAnchor) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
    ...
    public static void setWindowLayoutType(@NonNull PopupWindow popupWindow, int layoutType) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
