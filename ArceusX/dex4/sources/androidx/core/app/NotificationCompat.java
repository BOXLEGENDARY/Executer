...
public class NotificationCompat {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) throws Resources.NotFoundException {
            ArrayList<Action> arrayList;
            int numActions;
            RemoteViews remoteViews = applyStandardTemplate(true, R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(R.id.actions);
            boolean actionsVisible = false;
            if (showActions && (arrayList = this.mBuilder.mActions) != null && (numActions = Math.min(arrayList.size(), 3)) > 0) {
                actionsVisible = true;
