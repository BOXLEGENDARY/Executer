...
public class ViewCompat {
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View v, @NonNull OnUnhandledKeyEventListenerCompat listener) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            Map<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (Map) v.getTag(i);
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners2 = (ArrayList) v.getTag(i2);
        if (viewListeners2 == null) {
            viewListeners2 = new ArrayList<>();
            v.setTag(i2, viewListeners2);
        }
