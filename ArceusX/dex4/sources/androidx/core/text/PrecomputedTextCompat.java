...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        public boolean equals(@Nullable Object o) {
            ...
            int i = Build.VERSION.SDK_INT;
            if (i >= 23 && (this.mBreakStrategy != other.getBreakStrategy() || this.mHyphenationFrequency != other.getHyphenationFrequency())) {
                return false;
            }
            if ((i >= 18 && this.mTextDir != other.getTextDirection()) || this.mPaint.getTextSize() != other.getTextPaint().getTextSize() || this.mPaint.getTextScaleX() != other.getTextPaint().getTextScaleX() || this.mPaint.getTextSkewX() != other.getTextPaint().getTextSkewX()) {
                return false;
            }
