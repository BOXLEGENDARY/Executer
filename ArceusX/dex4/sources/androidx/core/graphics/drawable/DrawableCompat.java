...
public final class DrawableCompat {
    ...
    public static boolean setLayoutDirection(@NonNull Drawable drawable, int layoutDirection) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        int i = Build.VERSION.SDK_INT;
        if (i >= 23) {
