...
class VersionedParcelStream extends VersionedParcel {
    ...
    public boolean readField(int fieldId) throws IOException {
        ...
        while (true) {
            try {
                ...
                int i = buffer2.mFieldId;
                if (i == fieldId) {
                    this.mCurrentInput = buffer2.mInputStream;
                    return true;
                }
                this.mCachedFields.put(i, buffer2);
            } catch (IOException e) {
                return false;
            }
        }
    ...
    private void writeObject(Object o) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        if (o == null) {
            writeInt(0);
            return;
        }
